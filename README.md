...
To build the final jar and optimize the ServiceReference application for production, run:
...
Then navigate to [http://localhost:8025](http://localhost:8025) in your browser.
